...
public class ResponsableStages extends Utilisateur {
	...
	public ResponsableStages(String nom, String prenom, String login, String email, String password,List<Notification> notifivations,String cIN, List<Commentaire> commentiares,Collection<Role> roles) {
